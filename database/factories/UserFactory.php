...
// Ejecutar en la consola > php artisan db:seed  < para verificar e insertar
// Ejecutar para hacer un rollback de la base da datos en la consola > php artisan migrate:refresh --seed
